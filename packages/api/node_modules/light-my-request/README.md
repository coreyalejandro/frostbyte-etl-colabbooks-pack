...
Checks if given object `obj` is a _light-my-request_ `Request` object.
...
This project has been forked from [`hapi/shot`](https://github.com/hapijs/shot) because we wanted to support _Node ≥ v4_ and not only _Node ≥ v8_.
