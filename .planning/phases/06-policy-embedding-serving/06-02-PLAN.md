...
depends_on: []
files_modified:
  - docs/design/EMBEDDING_INDEXING_PLAN.md
autonomous: true
...
must_haves:
  ...
  artifacts:
    - path: "docs/design/EMBEDDING_INDEXING_PLAN.md"
