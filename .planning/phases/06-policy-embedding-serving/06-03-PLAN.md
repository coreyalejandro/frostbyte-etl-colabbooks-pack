...
depends_on: []
files_modified:
  - docs/design/SERVING_LAYER_PLAN.md
autonomous: true
...
must_haves:
  ...
  artifacts:
    - path: "docs/design/SERVING_LAYER_PLAN.md"
