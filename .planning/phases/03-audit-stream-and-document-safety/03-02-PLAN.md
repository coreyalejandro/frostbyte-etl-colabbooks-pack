...
depends_on: []
files_modified:
  - docs/security/DOCUMENT_SAFETY.md
autonomous: true
...
must_haves:
  ...
  artifacts:
    - path: "docs/security/DOCUMENT_SAFETY.md"
      ...
      min_lines: 400
  key_links:
    - from: "docs/security/DOCUMENT_SAFETY.md"
      to: "docs/product/PRD.md Phase C, Appendix C, Appendix G"
      via: "Injection gate (Phase C), allowlist (Appendix C), injection patterns (Appendix G)"
      pattern: "injection|allowlist|envelope"
    - from: "docs/security/DOCUMENT_SAFETY.md"
      to: "docs/security/THREAT_MODEL_SAFETY.md"
...
Output: `docs/security/DOCUMENT_SAFETY.md` — a standalone architecture specification covering SAFETY-01, SAFETY-02, SAFETY-03.
</objective>
...
@docs/product/PRD.md (Phase C, Appendix C allowlist, Appendix G injection patterns)
@docs/security/THREAT_MODEL_SAFETY.md (Controls A, B)
...
<task type="auto">
  ...
  <files>docs/security/DOCUMENT_SAFETY.md</files>
  <action>
Create `docs/security/DOCUMENT_SAFETY.md` with the following structure:
...
1. grep -c "regex\|pattern\|injection" docs/security/DOCUMENT_SAFETY.md >= 25
2. grep -c "0\\.3\|0\\.7\|PASS\|FLAG\|QUARANTINE" docs/security/DOCUMENT_SAFETY.md >= 8
3. grep -c "mermaid\|flowchart\|decision" docs/security/DOCUMENT_SAFETY.md >= 1
4. wc -l docs/security/DOCUMENT_SAFETY.md >= 200
...
1. grep -c "envelope\|content\|CONTENT_START\|CONTENT_END" docs/security/DOCUMENT_SAFETY.md >= 15
2. grep -c "Stage A\|Stage B\|Stage C\|Stage D\|Stage E" docs/security/DOCUMENT_SAFETY.md >= 5
3. wc -l docs/security/DOCUMENT_SAFETY.md >= 350
...
1. grep -c "MIME\|allowlist\|libmagic\|extension" docs/security/DOCUMENT_SAFETY.md >= 20
2. grep -c "application/pdf\|application/vnd.openxmlformats" docs/security/DOCUMENT_SAFETY.md >= 5
3. grep -c "reject\|Reject\|UNSUPPORTED_FORMAT" docs/security/DOCUMENT_SAFETY.md >= 5
4. wc -l docs/security/DOCUMENT_SAFETY.md >= 400
...
- docs/security/DOCUMENT_SAFETY.md exists with >= 400 lines
