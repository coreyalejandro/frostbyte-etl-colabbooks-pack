...
must_haves:
  ...
  artifacts:
    - path: "docs/STORAGE_LAYER_PLAN.md"
...
<context>
@docs/TENANT_ISOLATION_STORAGE_ENCRYPTION.md (Sections 2–5, 6, 10)
@docs/AUDIT_ARCHITECTURE.md (Section 2.3)
@docs/PRD.md (Section 3.4 steps 4–7, 3.6)
</context>
...
<task type="auto">
  ...
  <files>docs/STORAGE_LAYER_PLAN.md</files>
  <action>
Create `docs/STORAGE_LAYER_PLAN.md` with:
...
<success_criteria>
- docs/STORAGE_LAYER_PLAN.md exists, >= 400 lines
