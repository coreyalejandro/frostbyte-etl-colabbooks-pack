...
must_haves:
  truths:
    ...
    - "The plan references docs/TENANT_ISOLATION_*.md and docs/AUDIT_ARCHITECTURE.md by specific section"
  artifacts:
    - path: "docs/FOUNDATION_LAYER_PLAN.md"
...
@docs/TENANT_ISOLATION_STORAGE_ENCRYPTION.md (Section 6: config, secrets)
...
<task type="auto">
  ...
  <files>docs/FOUNDATION_LAYER_PLAN.md</files>
  <action>
Create `docs/FOUNDATION_LAYER_PLAN.md` with:
...
<success_criteria>
- docs/FOUNDATION_LAYER_PLAN.md exists, >= 300 lines
