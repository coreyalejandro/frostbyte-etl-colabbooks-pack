...
depends_on: []
files_modified:
  - docs/design/PARSING_PIPELINE_PLAN.md
autonomous: true
...
must_haves:
  ...
  artifacts:
    - path: "docs/design/PARSING_PIPELINE_PLAN.md"
...
<context>
@docs/product/PRD.md (Section 2.2 Phase B: parsing stages, canonical JSON schema, error handling)
@docs/reference/TECH_DECISIONS.md (Docling >=2.70, Unstructured >=0.16, Pydantic >=2.10)
@docs/architecture/AUDIT_ARCHITECTURE.md (Section 1.2: DOCUMENT_PARSED, DOCUMENT_PARSE_FAILED, CONTENT_DROPPED)
@docs/architecture/STORAGE_LAYER_PLAN.md (MinIO paths: normalized/{tenant_id}/{doc_id}/structured.json)
</context>
...
<task type="auto">
  ...
  <files>docs/design/PARSING_PIPELINE_PLAN.md</files>
  <action>
Create `docs/design/PARSING_PIPELINE_PLAN.md` with:
...
<success_criteria>
- docs/design/PARSING_PIPELINE_PLAN.md exists, >= 450 lines
