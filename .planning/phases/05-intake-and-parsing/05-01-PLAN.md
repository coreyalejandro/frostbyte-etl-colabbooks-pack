...
must_haves:
  ...
  artifacts:
    - path: "docs/INTAKE_GATEWAY_PLAN.md"
...
<context>
@docs/PRD.md (Section 2.1 Phase A, Section 5.4 Intake API)
@docs/DOCUMENT_SAFETY.md (Section 3: MIME verification, libmagic, allowlist)
@docs/AUDIT_ARCHITECTURE.md (Section 1.2: BATCH_RECEIVED, DOCUMENT_INGESTED, DOCUMENT_REJECTED, DOCUMENT_QUARANTINED)
@docs/TECH_DECISIONS.md (python-magic, ClamAV, python-jose, python-multipart)
@docs/FOUNDATION_LAYER_PLAN.md (tenant config, emit_audit_event)
...
<task type="auto">
  ...
  <files>docs/INTAKE_GATEWAY_PLAN.md</files>
  <action>
Create `docs/INTAKE_GATEWAY_PLAN.md` with:
...
<success_criteria>
- docs/INTAKE_GATEWAY_PLAN.md exists, >= 400 lines
