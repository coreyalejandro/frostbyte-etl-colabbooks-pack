...
depends_on: [07-01]
files_modified:
  - docs/reference/MODE_PARITY_AND_OFFLINE_UPDATE.md
autonomous: true
...
must_haves:
  ...
  artifacts:
    - path: "docs/reference/MODE_PARITY_AND_OFFLINE_UPDATE.md"
